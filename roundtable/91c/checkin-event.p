/*  =========================================================================
    file    : prolint/roundtable/91c/checkin-event.p
...
DEFINE INPUT PARAMETER rcObject    AS RECID   NO-UNDO.
...
RUN prolint/roundtable/91c/checkin-handler.p PERSISTENT SET outputhandler.
...
FIND rtb.rtb_wspace WHERE rtb.rtb_wspace.wspace-id = grtb-wspace-id NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    vTaskNumber = Grtb-task-num.

    FIND brtb_object NO-LOCK WHERE RECID(brtb_object) = rcObject NO-ERROR.
