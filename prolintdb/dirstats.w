...
/* =======================================================================================
    file    : prolint/prolintdb/dirstats.w
    purpose : query data in prolintdb by subdirectory
...
&Scoped-define INTERNAL-TABLES lint_stat_subdir lint_stat_ruledir

/* Definitions for BROWSE BROWSE-1                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 lint_stat_subdir.subdir lint_stat_subdir.numwarnings lint_stat_subdir.score lint_stat_subdir.severity   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 lint_stat_subdir.severity   
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-1 lint_stat_subdir
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-1 lint_stat_subdir
&Scoped-define SELF-NAME BROWSE-1
&Scoped-define OPEN-QUERY-BROWSE-1 /* OPEN QUERY {&SELF-NAME} FOR EACH lint_stat_subdir NO-LOCK INDEXED-REPOSITION. */    RUN OpenBrowse1.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 lint_stat_subdir
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 lint_stat_subdir


/* Definitions for BROWSE BROWSE-2                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 lint_stat_ruledir.ruleid lint_stat_ruledir.numwarnings lint_stat_ruledir.score lint_stat_ruledir.severity   
...
&Scoped-define OPEN-QUERY-BROWSE-2 /* OPEN QUERY {&SELF-NAME} FOR EACH lint_stat_ruledir NO-LOCK                             WHERE lint_stat_ruledir.subdir = lint_stat_subdir.subdir                             INDEXED-REPOSITION. */ RUN OpenBrowse2.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 C-Win _FREEFORM
  QUERY BROWSE-1 NO-LOCK DISPLAY
      lint_stat_subdir.subdir FORMAT "X(32)":U 
      lint_stat_subdir.numwarnings FORMAT "->,>>>,>>9":U WIDTH 20.4
      lint_stat_subdir.score FORMAT "->>,>>>,>>9":U WIDTH 20.2
      lint_stat_subdir.severity FORMAT ">9":U WIDTH 19.6
  ENABLE
      lint_stat_subdir.severity
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 C-Win _FREEFORM
  QUERY BROWSE-2 NO-LOCK DISPLAY
      lint_stat_ruledir.ruleid FORMAT "X(15)":U WIDTH 22.2
      lint_stat_ruledir.numwarnings FORMAT "->,>>>,>>9":U WIDTH 22.2
      lint_stat_ruledir.score FORMAT "->,>>>,>>9":U WIDTH 27.2
      lint_stat_ruledir.severity FORMAT ">9":U WIDTH 19.2
  ENABLE
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Statistics by subdirectory"
         HEIGHT             = 20.1
         WIDTH              = 103.2
         MAX-HEIGHT         = 25.1
         MAX-WIDTH          = 143.2
...
/* Query rebuild information for BROWSE BROWSE-1
     _START_FREEFORM
/* OPEN QUERY {&SELF-NAME} FOR EACH lint_stat_subdir NO-LOCK INDEXED-REPOSITION. */
...
/* OPEN QUERY {&SELF-NAME} FOR EACH lint_stat_ruledir NO-LOCK
                            WHERE lint_stat_ruledir.subdir = lint_stat_subdir.subdir
                            INDEXED-REPOSITION. */
RUN OpenBrowse2.
     _END_FREEFORM
     _Options          = "NO-LOCK INDEXED-REPOSITION"
...
ON END-ERROR OF C-Win /* Statistics by subdirectory */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Statistics by subdirectory */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  lint_stat_subdir.severity:read-only in browse browse-1 = true.
...
------------------------------------------------------------------------------*/
  ...
  CASE order :
     WHEN 1 THEN  OPEN QUERY browse-1 FOR EACH prolintdb.lint_stat_subdir NO-LOCK BY prolintdb.lint_stat_subdir.subdir.
     WHEN 2 THEN  OPEN QUERY browse-1 FOR EACH prolintdb.lint_stat_subdir NO-LOCK BY prolintdb.lint_stat_subdir.severity DESCENDING.
     WHEN 3 THEN  OPEN QUERY browse-1 FOR EACH prolintdb.lint_stat_subdir NO-LOCK BY prolintdb.lint_stat_subdir.numwarnings DESCENDING.
     WHEN 4 THEN  OPEN QUERY browse-1 FOR EACH prolintdb.lint_stat_subdir NO-LOCK BY prolintdb.lint_stat_subdir.score DESCENDING.
  END CASE.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE prolintdb.lint_stat_subdir THEN
       CASE order :
           WHEN 1 THEN  OPEN QUERY browse-2 FOR EACH prolintdb.lint_stat_ruledir NO-LOCK WHERE prolintdb.lint_stat_ruledir.subdir = prolintdb.lint_stat_subdir.subdir BY prolintdb.lint_stat_ruledir.ruleid.
           WHEN 2 THEN  OPEN QUERY browse-2 FOR EACH prolintdb.lint_stat_ruledir NO-LOCK WHERE prolintdb.lint_stat_ruledir.subdir = prolintdb.lint_stat_subdir.subdir BY prolintdb.lint_stat_ruledir.severity DESCENDING.
           WHEN 3 THEN  OPEN QUERY browse-2 FOR EACH prolintdb.lint_stat_ruledir NO-LOCK WHERE prolintdb.lint_stat_ruledir.subdir = prolintdb.lint_stat_subdir.subdir BY prolintdb.lint_stat_ruledir.numwarnings DESCENDING.
           WHEN 4 THEN  OPEN QUERY browse-2 FOR EACH prolintdb.lint_stat_ruledir NO-LOCK WHERE prolintdb.lint_stat_ruledir.subdir = prolintdb.lint_stat_subdir.subdir BY prolintdb.lint_stat_ruledir.score DESCENDING.
       END CASE.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT AVAILABLE prolintdb.lint_stat_ruledir THEN RETURN ERROR "No active record".
