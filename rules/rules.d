...
"backslash" 2 yes no no yes yes "String containing '\' without prefix '~'" "Windows/Unix-portability"
...
"defaultnamemag" 3 yes no no no no "Magic - Nom des Widgets" "Style"
"do1" 3 yes no no no no "'DO: ... END.' contains only one statement" "Style"
...
"nameconvmagic" 5 yes no no yes yes "Magic - Norme nom variable et paramètre" "Style"
...
"nopprsininclude" 5 yes no no no no "no preprocessor in include" "Bug"
...
"obsoletenodes" 5 yes no no no yes "find obsolete keywords, configured in obsolete.d (RECID for instance)" "Coding standard"
...
"tablename" 9 yes no no yes no "unqualified fieldnames (should be qualified like TABLE.FIELD)" "Bug"
...
"where-udf" 9 yes no no yes no "User-defined function used in WHERE clause" "Bug"
"wholeindex" 9 no no yes no no "WHOLE-INDEX found in xref (not necessary a bug, can be wanted)" "Performance"
